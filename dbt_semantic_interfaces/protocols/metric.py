...
class MetricParameter(Protocol):
    ...
    @property
    @abstractmethod
    def type(self) -> ParameterType:  # noqa: D
        pass
    ...
    @property
    @abstractmethod
    def default(self) -> Optional[Any]:  # noqa: D
        pass

    @property
    @abstractmethod
    def allowed_values(self) -> Optional[Sequence[Any]]:  # noqa: D
        pass

    @property
    @abstractmethod
    def min(self) -> Optional[float]:  # noqa: D
        pass

    @property
    @abstractmethod
    def max(self) -> Optional[float]:  # noqa: D
        pass
